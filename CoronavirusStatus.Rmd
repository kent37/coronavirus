...
```{r growth_total, fig.height=nrows*1.2+0.5}
print(growth_total)
```
...
```{r death_us_totals, fig.height=nrows*2.2+0.5}
...
```{r selected_counties_plot, fig.height=6, fig.width=8}
print(selected_counties_plot)
```

###### Log

```{r selected_counties_log_plot, fig.height=6, fig.width=8}
print(selected_counties_log_plot)
```

##### Growth

```{r growth_chart_county, fig.height=nrows*2.2+0.5}
print(growth_chart_county)
```

##### Totals

```{r growth_county_totals, fig.height=nrows}
print(growth_county_totals)
```
...
```{r selected_counties_death_plot, fig.height=6, fig.width=8}
print(selected_counties_death_plot)
```

###### Log

```{r selected_counties_death_log_plot, fig.height=6, fig.width=8}
print(selected_counties_death_log_plot)
```

##### Growth

```{r death_chart_county, fig.height=nrows*2+0.5}
print(death_chart_county)
```

##### Totals

```{r death_county_totals, fig.height=nrows*2.2+0.5}
print(death_county_totals)
```
